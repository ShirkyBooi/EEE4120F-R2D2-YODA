...
HD_PWD='C:/Users/ethan/YODA_R2D2/YODA_R2D2.runs/AddressLUT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AddressLUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AddressLUT.tcl
