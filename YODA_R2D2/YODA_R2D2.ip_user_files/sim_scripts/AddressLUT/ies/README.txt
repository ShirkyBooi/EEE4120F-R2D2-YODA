...
#
# Generated by export_simulation on Fri Jun 26 17:54:18 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './AddressLUT.sh' script.

./AddressLUT.sh -reset_run
...
./AddressLUT.sh -noclean_files

For more information on the script, please type './AddressLUT.sh -help'.
